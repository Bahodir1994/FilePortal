...
function webSocketOnMessage(event){
    ...
    var peerUsername = parsedData['action'];
...
const btnToogleAudio = document.querySelector('#btn-toggle-video');
...
var userMedia = navigator.mediaDevices.getUserMedia(constraints)
    .then(stream => {
        ...
        var audioTracks = stream.getVideoTracks();
    ...
    .catch(error =>{
        ...
        function addLocalTracks(peer){
            localStream.getTracks().forEach(track =>{
                peer.addTracks(track, localStream);
            });
        ...
        function setOnTrack(peer, remoteVideo){
            ...
            peer.addEventListener('track', async (event) => {
                remoteStream.addTracks(event.track, remoteStream);
            });
        }
